...
export const id: Partial<Record<MessageKey, string>> = {
  ...
  "templates.subtitle":
    "Templat perusahaan yang terdaftar di mesin pembuatan slide. Berkas .pptx yang diunggah menentukan mereknya -- unggah dek untuk mendaftarkannya.",
  ...
  "templates.dropPptxHint": "Mesin menurunkan tata letak, font, dan palet langsung dari berkas ini.",
  "templates.selectFile": "Pilih berkas .pptx",
  "templates.changeFile": "Ganti berkas",
  "templates.pptxRequired": "Berkas .pptx wajib diisi -- mesin tidak memiliki apa pun untuk didaftarkan tanpanya.",
  ...
  "templates.testInEditor": "Uji di editor",
  "templates.reregister": "Daftarkan ulang",
  "templates.reregisterFailed": "Pendaftaran ulang gagal.",
  "templates.registrationPending": "Mendaftarkan…",
  "templates.registrationNoSource": "Tidak ada berkas diunggah",
