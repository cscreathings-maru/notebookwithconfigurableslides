...
export const en = {
  ...
  "templates.subtitle":
    "Company templates that register with the slide engine. The uploaded .pptx determines branding -- upload a deck to register it.",
  ...
  "templates.dropPptxHint": "The engine derives layouts, fonts, and palette directly from this file.",
  "templates.selectFile": "Select .pptx file",
  "templates.changeFile": "Change file",
  "templates.pptxRequired": "A .pptx file is required -- the engine has nothing to register without one.",
  ...
  "templates.testInEditor": "Test in editor",
  "templates.reregister": "Re-register",
  "templates.reregisterFailed": "Re-registration failed.",
  "templates.registrationPending": "Registering…",
  "templates.registrationNoSource": "No file uploaded",
